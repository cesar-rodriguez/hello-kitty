...
output "aws_s3_stackgen_hello_kitty_cesar_demo_arn" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.arn
  sensitive = false
}


output "aws_s3_stackgen_hello_kitty_cesar_demo_bucket_name" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_name
  sensitive = false
}


output "aws_s3_stackgen_hello_kitty_cesar_demo_bucket_website_endpoint" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_website_endpoint
  sensitive = false
}


output "aws_s3_stackgen_hello_kitty_cesar_demo_kms_arn" {
